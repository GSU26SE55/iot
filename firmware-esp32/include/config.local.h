// ==================================================================
// include/config.local.h — Cấu hình môi trường LOCAL DEV
// IP máy chủ: 192.168.1.5
// Backend ApiGateway: http://192.168.1.5:4001
// MQTT Mosquitto Local: 192.168.1.5:21883 (Plain TCP, không TLS)
// ==================================================================
#pragma once

// --------- WiFi ----------
// Điền SSID và Pass Wi-Fi nhà bạn nếu muốn tự nối khi NVS trống,
// hoặc để rỗng để cấu hình qua captive portal SolarGW-xxxx.
#define WIFI_SSID       ""
#define WIFI_PASS       ""
...
// ============== Backend Local ==============
#define BACKEND_URL         "http://192.168.1.5:4001"
...
#define HTTP_INGEST_TIMEOUT_MS  2000

// ============== MQTT — LOCAL PLAIN ==============
#define MQTT_BROKER_HOST    "192.168.1.5"
#define MQTT_BROKER_PORT    21883
#define MQTT_USE_TLS        0                // 0 = plain (Local dev)
...
#define TLS_ALLOW_INSECURE  1                // 1 cho phép dev local
#endif

...
Firmware production dùng `https://api.solars.io.vn` làm HTTPS fallback và
`mqtt.solars.io.vn:8883` làm MQTT TLS broker. Đây là các endpoint public không bí mật; pipeline
